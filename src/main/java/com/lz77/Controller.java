...
public class Controller {
    ...
    public void initialize() {
        ...
        menuAbout.setOnAction(actionEvent -> {
            showDialog(Alert.AlertType.INFORMATION, "Автор", "A_Lyaska");
        });
        ...
        btnOpenSourceFile.addEventHandler(MouseEvent.MOUSE_CLICKED, mouseEvent -> {
            ...
            if (file != null) {
                try {
                    ...
                    showDialog(Alert.AlertType.ERROR, "Error", "Неверный загружаемый файл");
                }
            }
        });
        ...
        btnOpenCodedFile.addEventHandler(MouseEvent.MOUSE_CLICKED, mouseEvent -> {
            ...
            if (file != null) {
                try {
                    ...
                    System.err.println(e.toString());
                    showDialog(Alert.AlertType.ERROR, "Error", "Неверный выгружаемый файл");
                }
            }
        });
    }
